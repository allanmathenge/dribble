  ...
  return (
    <nav className="h-24 px-6">
        <div className="flex justify-between items-center">
            ...
            <div className="sm:flex"><CgDetailsMore /></div>
            ...
            <div className="flex flex-row gap-3 justify-center items-center">
                <div className="">
                    ...
                    <input type="text" className="px-5 py-2 hidden sm:flex rounded-full bg-gray-100 focus:bg-white focus:outline-slate-300 md:hidden" placeholder="Search..." />
                </div>
                <div>
